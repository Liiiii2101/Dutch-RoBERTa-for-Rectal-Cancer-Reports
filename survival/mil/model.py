...
class MILModel(nn.Module):
    ...
    def forward(self, bags, lens):
        ...
        #print('bag shape and data shape', bags.shape[0], lens.shape[0])
        ...
        #     embeddings, lens)
        # #print('attention scores', masked_attention_scores)
        # weighted_embedding_sums = (
        #     masked_attention_scores * embeddings).sum(-2)

        scores = self.head(embeddings)#self.head(weighted_embedding_sums)
